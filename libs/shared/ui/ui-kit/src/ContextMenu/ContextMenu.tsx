...
>(({ className, inset, destructive, children, icon, ...props }, ref) => (
  <ContextMenuPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex cursor-default select-none items-center rounded-sm py-1.5 px-2 text-sm font-medium outline-none focus:bg-slate-100 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 dark:focus:bg-slate-700 cursor-pointer',
      inset && 'pl-8',
    ...
    {...props}
  >
    {icon ? React.cloneElement(icon, { className: 'h-4 w-4 mr-2' }) : null}
    {children}
  </ContextMenuPrimitive.Item>
));
